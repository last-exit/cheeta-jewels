...
export const COLLECTIONS: Record<string, CollectionData> = {
  maharaja: {
    ...
    theme: {
      bg: "#E7DCC7",
      ink: "#241708",
      soft: "rgba(36,23,8,0.65)",
      accent: "#9A6B22",
      line: "rgba(36,23,8,0.12)",
      tint: "rgba(36,23,8,0.04)",
      isDark: false,
    },
    products: [
      {
      ...
      {
        id: "maharaja-02",
        name: "Maharaja II — Imperial Filigree",
        material: "24K Gold Vermeil · Smoked Topaz Lenses",
        price: 19200,
        priceDisplay: "AED 19,200",
        quad: "/products/maharaja-2.jpg",
      },
      {
        id: "maharaja-03",
        name: "Maharaja III — Hexagonal Shield",
        material: "Architectural Brass & Gold · Honey Flash Lenses",
        price: 17800,
        priceDisplay: "AED 17,800",
        quad: "/products/maharaja-3.jpg",
      },
      {
        id: "maharaja-04",
        name: "Maharaja IV — Sovereign Dual-Tone",
        material: "Gold & Obsidian · Dark Amber Lenses",
        price: 21000,
    ...
    credits: [
      ...
      { role: "METALLURGIST", name: "HARI SINGH & SONS, JAIPUR" },
      { role: "CINEMATOGRAPHY", name: "KABIR MALHOTRA" },
      { role: "OPTICAL ARCHIVE", name: "CHEETA JEWELS DIVISION" },
    ],
    modelConfig: {
      frameType: "gold",
      defaultLens: "amber",
      availableLenses: [
        { id: "amber", label: "Amber Topaz", hex: "#B86314" },
        { id: "ruby", label: "Imperial Ruby", hex: "#8A0E1C" },
        { id: "emerald", label: "Muzo Emerald", hex: "#0F5C43" },
      ],
      title: "18K Solid Gold Double Barrel",
      subtitle: "Architectural Hand-Chiseled Jali Browbar · Drag to Rotate 360°",
    },
    nextId: "masquerade",
    nextName: "MASQUERADE",
  ...
  masquerade: {
    id: "masquerade",
    index: "02",
    eyebrow: "FW26 — CHAPTER 02",
    title: "MASQUERADE",
    subtitle: "OBSIDIAN LACQUER & SCULPTED TITANIUM",
    cta: "View the Collection",
    secondary: "Acquire Edition",
    label: "02 / 04 — MASQUERADE",
    ...
    theme: {
      bg: "#120E11",
      ink: "#EDE2E2",
      soft: "rgba(237,226,226,0.65)",
      accent: "#8E2438",
      line: "rgba(237,226,226,0.12)",
      tint: "rgba(237,226,226,0.04)",
      isDark: true,
    },
    products: [
      {
    ...
    nextId: "savanah",
    nextName: "SAVANAH",
    nextCampaign: "/campaigns/savanah-poster.jpg",
  },
  ...
  barrel: {
    id: "barrel",
    index: "04",
    eyebrow: "FW26 — CHAPTER 04",
    title: "BARREL",
    subtitle: "KNURLED GUNMETAL & BOURBON PATINA",
    cta: "View the Collection",
    secondary: "Acquire Edition",
    label: "04 / 04 — BARREL",
    pageTitle: "THE BARREL COLLECTION",
    intro:
      "TEMPERED INSIDE THE SHADOWS OF CENTURY-OLD FRENCH CELLARS, THE BARREL COLLECTION UNITES KNURLED GUNMETAL WITH CHARRED OAK PATINAS. ITS PROPRIETARY DUAL-CYLINDER CROSSBAR FORGES AN UNYIELDING INDUSTRIAL HORIZON, ECHOING THE RAW DISCIPLINE OF AGED GRAIN, SMOKED MINERAL OPTICS, AND TIME-HONORED COGNAC BRILLIANCE.",
    statement:
    ...
    campaign: "/campaigns/barrel-poster.jpg",
    frames: "/frames/barrel-frames.jpg",
    stills: [
      "/stills/barrel-still-1.jpg",
      "/stills/barrel-still-2.jpg",
    ...
    theme: {
      bg: "#17110C",
      ink: "#E9DCC6",
      soft: "rgba(233,220,198,0.65)",
      accent: "#B0702B",
      line: "rgba(233,220,198,0.12)",
      tint: "rgba(233,220,198,0.04)",
      isDark: true,
    },
    products: [
      {
...
export const COLLECTION_ORDER = ["maharaja", "masquerade", "savanah", "barrel"] as const;
